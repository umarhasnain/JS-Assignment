...
//Task 5
// let correctPassword = "password"; // Store the correct password

// let userPassword = prompt("Enter your password:"); // Ask the user to enter their password
...
//Task 7
// let time24 = prompt("Enter time in 24-hour clock format (e.g. 1900):"); // Ask the user to enter time in 24-hour clock format

// let time12; // Declare a variable to store the time in 12-hour clock format
...
//   let hour12 = time24.slice(0, 2) - 12; // Subtract 12 from the hour to convert it to 12-hour clock format
//   if (hour12 === 0) { // If the hour is 0, set it to 12
//     hour12 = 12;
//   }
//   let minute12 = time24.slice(2, 4); // Get the minutes from the time
